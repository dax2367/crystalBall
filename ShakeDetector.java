...
public class ShakeDetector implements SensorEventListener
{
    ...
    // Maximum time (in milliseconds) for the complete shake to occur
    private static final int MAX_SHAKE_DURATION = 500;
	
    // Arrays that store gravity and linear acceleration values
    ...
    @Override	// This method is called when the accelerometer detects a change in velocity.
    ...
    /*
     * The OnShakeListener definition would normally go into it's own .java file,
     * but for now it is easier to included it right here.
     */
